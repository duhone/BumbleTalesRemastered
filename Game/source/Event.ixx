/*
 *  Event.h
 *  Rewrite using variadic templates once there available. available starting in gcc 4.3, microsoft has not
 * said when they will add support for that c++0x feature yet.
 *
 *  Currently only supports up to 3 arguments. Also do not use large arguments, as arguments are passed by
 * value currently. primitives and really small structs should be ok.
 *
 *  Created by Eric Duhon on 1/25/09.
 *  Copyright 2009 Conjured Realms LLC. All rights reserved.
 *
 */
export module CR.Game.Event;

import CR.Game.FunctionObjects;
...
export namespace CR::Utility {
	...
	class IDelegate3 {
	  public:
		virtual ~IDelegate3()                                       = default;
		virtual void operator()(Arg1 _arg1, Arg2 _arg2, Arg3 _arg3) = 0;
	};

	class Event {
	  public:
		~Event() { Clear(); }
		unsigned int Size() const { return static_cast<unsigned int>(m_delegates.size()); }
		void Clear() {
		...
		void operator+=(IDelegate* _delegate) { m_delegates.push_back(_delegate); }
		void operator()() {
			CR::Utility::ForEach(m_delegates, [&](auto& delegate) { (*delegate)(); });
		}
	...
	class Event1 {
	  public:
		...
		void operator+=(IDelegate1<Arg1>* _delegate) { m_delegates.push_back(_delegate); }
		void operator()(Arg1 _arg1) {
			CR::Utility::ForEach(m_delegates, [&](auto& delegate) { (*delegate)(_arg1); });
		}
	...
	class Event2 {
	  public:
		...
		void operator+=(IDelegate2<Arg1, Arg2>* _delegate) { m_delegates.push_back(_delegate); }
		void operator()(Arg1 _arg1, Arg2 _arg2) {
			CR::Utility::ForEach(m_delegates, [&](auto& delegate) { (*delegate)(_arg1, _arg2); });
		}
	...
	class Event3 {
	  public:
		...
		void operator+=(IDelegate3<Arg1, Arg2, Arg3>* _delegate) { m_delegates.push_back(_delegate); }
		void operator()(Arg1 _arg1, Arg2 _arg2, Arg3 _arg3) {
			CR::Utility::ForEach(m_delegates, [&](auto& delegate) { (*delegate)(_arg1, _arg2, _arg3); });
		}
	...
	{
	public:
	    DelegateImpl(T *_classInstance,FUNCTOR _functor) : m_classInstance(_classInstance),
	m_functor(_functor) {} virtual void operator()()
	    {
	...
	class DelegateImpl : public IDelegate {
	  public:
		...
		DelegateImpl(T* _classInstance, FUNCTOR _functor) :
		    m_classInstance(_classInstance), m_functor(_functor) {}

		virtual void operator()() { (m_classInstance->*m_functor)(); }
	...
	{
	public:
	    DelegateImpl1(T *_classInstance,FUNCTOR _functor) : m_classInstance(_classInstance),
	m_functor(_functor) {} virtual void operator()(Arg1 _arg1)
	    {
	...
	*/
	...
	class DelegateImpl1 : public IDelegate1<Arg1> {
	  public:
		...
		DelegateImpl1(T* _classInstance, FUNCTOR _functor) :
		    m_classInstance(_classInstance), m_functor(_functor) {}

		virtual void operator()(Arg1 _arg1) { (m_classInstance->*m_functor)(_arg1); }
	...
	{
	public:
	    DelegateImpl2(T *_classInstance,FUNCTOR _functor) : m_classInstance(_classInstance),
	m_functor(_functor) {} virtual void operator()(Arg1 _arg1,Arg2 _arg2)
	    {
	...
	class DelegateImpl2 : public IDelegate2<Arg1, Arg2> {
	  public:
		...
		DelegateImpl2(T* _classInstance, FUNCTOR _functor) :
		    m_classInstance(_classInstance), m_functor(_functor) {}

		virtual void operator()(Arg1 _arg1, Arg2 _arg2) { (m_classInstance->*m_functor)(_arg1, _arg2); }
	...
	{
	public:
	    DelegateImpl3(T *_classInstance,FUNCTOR _functor) : m_classInstance(_classInstance),
	m_functor(_functor) {} virtual void operator()(Arg1 _arg1,Arg2 _arg2,Arg3 _arg3)
	    {
	...
	class DelegateImpl3 : public IDelegate3<Arg1, Arg2, Arg3> {
	  public:
		...
		DelegateImpl3(T* _classInstance, FUNCTOR _functor) :
		    m_classInstance(_classInstance), m_functor(_functor) {}
	...
	template<class T, typename Arg1, typename Arg2>
	DelegateImpl2<T, Arg1, Arg2>* Delegate2(T* _classInstance,
	                                        typename DelegateImpl2<T, Arg1, Arg2>::FUNCTOR _functor) {
	...
	*/
	...
	template<class T, typename Arg1, typename Arg2, typename Arg3>
	DelegateImpl3<T, Arg1, Arg2, Arg3>*
	    Delegate3(T* _classInstance, typename DelegateImpl3<T, Arg1, Arg2, Arg3>::FUNCTOR _functor) {
